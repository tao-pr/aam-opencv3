...
protected:
  ...
  unique_ptr<BaseFittedModel> generateNextBestModel(unique_ptr<BaseFittedModel> const& model, const Mat& sample, double* bestError, SearchWith* action = nullptr) const;
