...
public:
  ...
  virtual int getSizeOfPermutationOfParams() const = 0;
  virtual void permutationOfParams(Mat* out) const = 0;
...
public: 
  ...
  int getSizeOfPermutationOfParams() const;
  void permutationOfParams(Mat* out) const;
